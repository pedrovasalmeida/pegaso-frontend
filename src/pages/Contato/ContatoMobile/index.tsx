...
const ContatoMobile: React.FC = () => {
  ...
  return (
    <Container>
      <DivDireita>
        <Titulo animate={{ x: 0 }} transition={{ duration: 0.3 }}>
          Informações
        </Titulo>
        <Texto animate={{ x: 0 }} transition={{ duration: 0.5 }}>
      ...
      <DivEsquerda>
        ...
        <Texto animate={{ x: 0 }} transition={{ duration: 0.7 }}>
          CEP: 35950-000
        </Texto>

        <WhiteSpace />
        <Titulo animate={{ x: 0 }} transition={{ duration: 0.9 }}>
          Contato
        </Titulo>

        <Texto animate={{ x: 0 }} transition={{ duration: 1.1 }}>
          Tel: (11) 3456-7890
        </Texto>
        <Texto animate={{ x: 0 }} transition={{ duration: 1.3 }}>
          Fax: (11) 3456-7890
        </Texto>
        <Texto animate={{ x: 0 }} transition={{ duration: 1.5 }}>
          WhatsApp: (11) 93456-7890
        </Texto>

        <WhiteSpace />
        <Texto animate={{ x: 0 }} transition={{ duration: 1.7 }}>
          comercial@pegaso.com.br
        </Texto>
        <Texto animate={{ x: 0 }} transition={{ duration: 1.9 }}>
          parceiros@pegaso.com.br
        </Texto>
        <Texto animate={{ x: 0 }} transition={{ duration: 2.1 }}>
          vagas@pegaso.com.br
        </Texto>
      </DivEsquerda>
    </Container>
